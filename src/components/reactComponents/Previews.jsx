...
{/*         <button className="btn" onClick={() => handleFilter(categorias.Edificios)}>Edificios</button> */}
      ...
      <main className="main">
        {inmueblesFilter.map((inmueble) => (
          <a key={inmueble.url} href={`/venta/${inmueble.url}`} className="preview">
          ...
          <div className="disponible">
            {inmueble.disponible ? null : <p className="noDisponible">No disponible</p>}
          </div>
        </a>
        ))}
      </main>
